...
pkg_postinst() {
	...
	einfo "DEPEND=${DEPEND}"
	elog ""
	elog "rock4c64-headless-meta installed"
	...
	elog "version 0.0.3 provides a working rock4c_vpn.start tool in /etc/local.d/"
	elog "version 0.0.4 improves rock4_vpn.start tool and adds vpn/svc/temp monitoring"
	elog ""
	elog "Thank you for using rock4c64-headless-meta"
}
