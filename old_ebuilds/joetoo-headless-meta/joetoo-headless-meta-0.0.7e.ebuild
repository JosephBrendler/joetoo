...
IUSE="+innercore +lamp +nextcloud +mysql -mariadb +mkinitramfs +ntp -chrony +sysklogd -syslog-ng +netifrc -networkmanager"
...
src_install() {
	...
	insinto "/etc/portage/package.env/"
		newins "${FILESDIR}/package.env_joetoo" "package.env"
	insinto "/etc/portage/package.use/"
		newins "${FILESDIR}/package.use_joetoo" "joetoo"
		newins "${FILESDIR}/package.use_joetoo-headless-meta" "joetoo-headless-meta"
		newins "${FILESDIR}/package.use_00cpu_flags" "00cpu_flags"
	insinto "/etc/portage/package.accept_keywords/"
		newins "${FILESDIR}/package.accept_keywords_joetoo" "joetoo"
	insinto "/etc/portage/repos.d/"
		newins "${FILESDIR}/repo_gentoo-conf_joetoo" "gentoo.conf"
	insinto "/etc/rsync/"
