...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/gentoo_pv_kernel_image-5.18.0.tar.bz2"
...
RDEPEND="=sys-kernel/gentoo-sources-5.18.0"
DEPEND="${RDEPEND}"
