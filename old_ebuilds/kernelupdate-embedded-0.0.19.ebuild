...
src_install() {
	...
	elog "Installing script kernelupdate-embedded..."
	dodir "/usr/sbin/"
	...
	do
		if use ${board}; then
			...
			dodir "/etc/kernelupdate-embedded/${board}/"
...
pkg_postinst() {
	...
	elog ""
	elog "Version 0.0.19 adds Pi 5 (bcm2712-rpi-5-b) and consolidates src_install() "
	elog ""
