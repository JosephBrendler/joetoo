...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/gus-1.0.2.9999.tbz2"
...
src_install() {
	...
	if use distcc ; then
		...
		elog ""
		elog "To follow distcc-3.3, gus-1.0.1+ switches from 'pump emerge ...' to "
