...
pkg_postinst() {
	...
	elog "version 0.0.2 removed the genpi64 overlay versions of openrc and python(pgo)"
	elog "version 0.0.2 also drops networkmanager in favor of openrc (please edit /etc/conf.d/net)."
	elog "version 0.0.2 is preliminary. please report bugs to the maintainer."
	elog ""
