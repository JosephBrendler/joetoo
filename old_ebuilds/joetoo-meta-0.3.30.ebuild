...
IUSE="
	...
	-samba
	-sbc -bcm2712-rpi-5-b -bcm2711-rpi-4-b -bcm2710-rpi-3-b-plus -bcm2709-rpi-2-b -rk3288-tinker-s -rk3399-rock-pi-4c-plus -rk3399-tinker-2-s -rk3588s-orangepi-5
	"
...
src_install() {
	...
	insinto "/etc/portage/package.accept_keywords/"
		if use sbc ; then
			case $board in
				"bcm2712-rpi-5-b"|"bcm2711-rpi-4-b"|"bcm2710-rpi-3-b-plus"|"rk3399-rock-pi-4c-plus"|"rk3399-tinker-2-s"|"rk3588s-orangepi-5")
					# arch=arm64
	...
	insinto "/etc/portage/binrepos.conf/"
		if use sbc; then
			case $board in
				...
				"rk3399-rock-pi-4c-plus"|"rk3288-tinker-s"|"rk3399-tinker-2-s"|"rk3588s-orangepi-5")
					# nothing, yet
					;;
			esac
		else
