...
DEPEND="
	...
	mkinitramfs? (
		dev-util/mkinitramfs::joetoo
	jus? ( app-portage/jus::joetoo )
	script_header_brendlefly? ( dev-util/script_header_brendlefly::joetoo )
	Terminal? ( dev-util/Terminal::joetoo )
	compareConfigs? ( dev-util/compareConfigs::joetoo )
	gentoo_pv_kernel_image? ( sys-kernel/gentoo_pv_kernel_image::joetoo )
	cloudsync? ( net-misc/cloudsync::joetoo )
