...
src_install() {
	...
	insinto "/etc/"
		newins "${FILESDIR}/etc_portage_chrony_conf_joetoo" "chrony.conf"
...
pkg_postinst() {
	...
	elog "version 0.3.19- update package.env (for additional pkgs that have failed to compile with distcc)"
	elog ""
