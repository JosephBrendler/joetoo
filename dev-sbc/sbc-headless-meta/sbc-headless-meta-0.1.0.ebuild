...
RDEPEND="
	...
	boot-fw? (
		...
		rk3288-tinker-s?        ( >=sys-boot/rockchip-boot-firmware-1.20240424[rk3288-tinker-s(+)] )
		rk3399-rock-pi-4c-plus? ( >=sys-boot/rockchip-boot-firmware-1.20240424[rk3399-rock-pi-4c-plus(+)] )
