...
IUSE="+rk3288-tinker-s rk3288-tinker raspi3 raspi4b"

# tinker-s is default above, but "exactly one of" the options
REQUIRED_USE="
	^^ ( rk3288-tinker-s rk3288-tinker raspi3 raspi4b )
	"
...
pkg_postinst() {
	...
	elog ""
	elog "Version 0.1.2 incorporates kernelupdate-embedded.conf file(s) and generalizes for multiple models"
	elog ""
	elog ""
