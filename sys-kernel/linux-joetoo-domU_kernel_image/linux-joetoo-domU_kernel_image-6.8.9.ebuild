...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/linux-joetoo-domU_kernel_image-${PV}-gentoo.tar.bz2"
...
src_install() {
	...
	elog "Thank you for using linux-joetoo-domU__kernel_image"
}
