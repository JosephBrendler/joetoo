...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/linux-rk3288-tinker-s_kernel_image-6.4.12.tar.bz2"
...
RDEPEND="=sys-kernel/gentoo-sources-6.4.12"
DEPEND="${RDEPEND}"
