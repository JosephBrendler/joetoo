...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/gentoo_pv_kernel_image-6.2.11.tar.bz2"
...
RDEPEND="=sys-kernel/gentoo-sources-6.2.11"
DEPEND="${RDEPEND}"
