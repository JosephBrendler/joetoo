...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/gentoo_pv_kernel_image-5.16.14.tar.bz2"
...
RDEPEND="=sys-kernel/gentoo-sources-5.16.14"
DEPEND="${RDEPEND}"
