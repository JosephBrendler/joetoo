...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/hardened_VM-kernel_image-4.9.12.tar.bz2"
...
RDEPEND="=sys-kernel/hardened-sources-4.9.12"
DEPEND="${RDEPEND}"
