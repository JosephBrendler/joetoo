...
SRC_URI="https://raw.githubusercontent.com/JosephBrendler/myUtilities/master/gus-5.1.1.9999.tbz2"
...
src_install() {
	...
	elog ""
	elog "version 1.0.6 removed localepurge (deprecated), but the following (in"
	elog "   make.conf) should suffice:"
	elog ""
	elog "INSTALL_MASK=\"/usr/share/dev-perl/DBD-mysqllocale \\"
	elog "   -/usr/share/locale/en \\"
	elog "   -/usr/share/locale/en_US \\"
	elog "   -/usr/share/locale/kf5_all_languages \\"
	elog "   -/usr/share/locale/locale.alias"
	elog ""
