...
pkg_setup() {
	...
	else if use rk3588-radxa-rock-5b+; then export board="rk3588-radxa-rock-5b+"; export maker="rockchip"
	else if use rk3588s-orangepi-5; then export board="rk3588s-orangepi-5"; export maker="rockchip"
	else if use rk3588s-orangepi-5b; then export board="rk3588s-orangepi-5b"; export maker="rockchip"
