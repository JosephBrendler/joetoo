...
src_install() {
	...
	insinto /boot
	# install boot firmware files (like raspi OS boot/firmware directory)
...
pkg_postinst() {
	elog "Installed ${PN}"
	elog "ver 0.0.1 supports fsl-imx8mq-phanbell boot firmware"
	elog " 0.0.2 adds u-boot_reflash_resources for fsl-imx8mq-phanbell"
	elog ""
