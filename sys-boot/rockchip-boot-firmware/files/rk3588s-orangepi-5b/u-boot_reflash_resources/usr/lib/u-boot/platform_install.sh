# Armbian u-boot install script for linux-u-boot-orangepi5b-current 2017.09-Sa317-Pedb0-H4003-V475a-Bb703-R448a
# This file provides functions for deploying u-boot to a block device.
DIR=/usr/lib/linux-u-boot-current-orangepi5b
