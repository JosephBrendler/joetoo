...
pkg_postinst() {
	...
	elog " 6.1 corrects grub-related bugs"
	...
	elog " 8.0 migrates to a merged-usr-like layout and moves scripts to FILESDIR"
	elog " 8.0.1 adds verbosity to .conf and updates handling deps of executables"
	elog " 8.1.0 is a major rewrite of the make_sources algorithm"
	elog ""
