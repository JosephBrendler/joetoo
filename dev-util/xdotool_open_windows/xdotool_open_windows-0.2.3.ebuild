...
pkg_postinst() {
	...
	elog " 0.0.3/4 provide bugfixes and refinements for components"
	elog " 0.1.0 is a significant rewrite of these tools"
	...
	elog " 0.2.1-3 provide bugfixes and decouple terminal-open and ssh-launch"
	elog ""
